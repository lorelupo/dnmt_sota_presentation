...
%			\item<+(1)-|alert@+(1)> Alternatively, $\lim_{T\to\infty}Regret(T)/T=0$
%		\end{enumerate}
%	\end{block}
%	\end{column}
%
...
%	    \begin{itemize}
%	    \item<+(1)-|alert@+(1)><+-|alert@+> Simpler framework;
%	    \item<+(1)-|alert@+(1)><+-|alert@+> Share the exploration-exploitation tradeoff;
%	    \item<+(1)-|alert@+(1)><+-|alert@+> Ample literature available.
%	    \end{itemize}
%	 \end{block}
%	 
%	 \onslide<+->{	
...
%	   \begin{enumerate}
%	   		\item<+(1)-|alert@+(1)> Fail to converge
%	   		\item<+(1)-|alert@+(1)> The strategies learned are not profitable
%	   \end{enumerate}
%	   \end{alertblock}
%	\end{column}
%	\begin{column}{0.4\textwidth}
...
%		\begin{enumerate}
%			\item<+(1)-|alert@+(1)><2-> \textbf{Low signal-to-noise ratio}: extremely difficult to find tradable patterns in markets
%			\item<+(1)-|alert@+(1)><3-> \textbf{Quality of data}: unlikely to find patterns in daily prices of liquid stocks
%			\item<+(1)-|alert@+(1)><4-> \textbf{Weak features}: parametric policy must be powerful enough to capture the signal
%			\item<+(1)-|alert@+(1)><5-> \textbf{Non-stationarity of financial time-series}: a signal needs to be persistent
%		\end{enumerate}
%	\end{block}
%	}
