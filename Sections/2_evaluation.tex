...
\begin{frame}{Desiderata of Document-level MT Evaluation}
...
%	\begin{itemize}
%		\item<+(1)-|alert@+(1)> \textit{Rationale}: previous contrastive test suites are not suitable for DNMT systems because either they \textbf{don't provid context}, or they are \textbf{too small} to provide statistical significance \cite{bawden_evaluating_2018}.
